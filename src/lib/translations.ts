...
export const translations: Record<'pl', Translations> = {
  pl: {
    ...
    auth: {
      ...
      registerSuccess:
        'Zarejestrowano pomyślnie! Potwierdź rejestrację na email!',
      emailConfirmation: 'Potwierdź rejestrację',
      emailConfirmationText:
        'Aby dokończyć rejestrację, kliknij w link aktywacyjny wysłany na adres:',
      checkSpamFolder:
    ...
    forms: {
      ...
      dataProcessingConsent:
        'Wyrażam zgodę na przetwarzanie danych przez Politechnikę',
    ...
    payment: {
      ...
      transport:
        'Czy chcesz skorzystać z transportu zapewnionego przez Wtyczkę?',
      ...
      cancellationPolicy:
        'Jestem świadomy/a, że rezygnacja mniej niż 10 dni przed wydarzeniem oznacza brak zwrotu wpłaty',
