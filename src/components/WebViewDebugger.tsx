...
export default function WebViewDebugger() {
  const [detectedInfo, setDetectedInfo] = useState<ReturnType<
  ...
  return (
    <div className="fixed right-4 bottom-4 z-50 max-w-sm">
      <div className="rounded-lg border border-amber-400/40 bg-black/90 p-4 text-xs text-white">
        ...
        <div className="space-y-1">
          <div>
            ...
            <span
              className={`ml-2 ${detectedInfo.isWebView ? 'text-red-400' : 'text-green-400'}`}
            >
          ...
          <div>
            ...
            <span
              className={`ml-2 ${detectedInfo.canOpenExternal ? 'text-green-400' : 'text-red-400'}`}
            >
          ...
          <div className="mt-2 border-t border-gray-600 pt-2">
            ...
            <div className="mt-1 text-xs break-all text-gray-300">
